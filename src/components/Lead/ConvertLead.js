...
function ConvertLead() {
    ...
    useEffect(() => {
        const getPlans = async () => {
            ...
            const getLead = await fetch(
                `http://localhost/yii/crmfinal/frontend/web/index.php/leads/${id}`
            );
    ...
    async function submitHandler(event) {
        ...
        const opportunities = await fetch(`http://localhost/yii/crmfinal/frontend/web/index.php/leads/convert`, {
            headers: {
