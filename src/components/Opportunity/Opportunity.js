...
const Opportunity = () => {
    ...
    const changeHandler = async (event) => {
        const res = await fetch(
            `http://localhost/yii/crmfinal/frontend/web/index.php/opportunities?filter[${event.target.id}][like]=${event.target.value}`
        );
    ...
    const priceChangeHandler = async (event) => {
        const res = await fetch(
            `http://localhost/yii/crmfinal/frontend/web/index.php/opportunities?filter[${event.target.id}]=${event.target.value}`
        );
        const data = await res.json();
        // console.log(data);
        setItems(data);
    ...
    const getComments = async () => {
        const demo = await fetch(
            `http://localhost/yii/crmfinal/frontend/web/index.php/opportunities`
        );
        const datademo = await demo.json();
        const total = datademo.length;
        const res = await fetch(
            `http://localhost/yii/crmfinal/frontend/web/index.php/opportunities?per-page=${limit}&page=1`
        );
        const data = await res.json();
        // console.log(data);
        setItems(data);
    ...
    const fetchComments = async (currentPage) => {
        ...
        const res = await fetch(
            `http://localhost/yii/crmfinal/frontend/web/index.php/opportunities?per-page=${limit}&page=${currentPage}`
        );
        const data = await res.json();
        return data;
    };
    ...
    const deletefn = async (id) => {
        ...
        if (window.confirm('Are you sure you want to delete ?')) {
            ...
            await fetch(`http://localhost/yii/crmfinal/frontend/web/index.php/opportunities/${id}`, {
                method: 'DELETE',
    ...
    const handleSorting = async (event) => {
        ...
        const res = await fetch(
            `http://localhost/yii/crmfinal/frontend/web/index.php/opportunities?sort=${event}`
        );
        const data = await res.json();
        // console.log(data);
        setItems(data);
                            ...
                            <table className="min-w-full">
                                <thead className="bg-white border-b">
                                    <tr className="bg-gray-400 border-b tran    tion duration-300 ease-in-out">
                                        ...
                                        <td colSpan="2" className="font-bold text-2xl text-center text-white px-6 py-4">
